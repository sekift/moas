...
@Configuration
public class BishijieParser {
    private static Logger logger = LoggerFactory.getLogger(BishijieParser.class);
...
//        System.out.println("topNewsUrl="+topNewsUrl);
        ...
        Elements eles = element.getElementsByClass("content");
...
//            System.out.println("e="+e);
            ...
            if (e.hasText() && e.hasAttr("href")
                ...
                String linkurl = Consts.BISHIJIE_DOMAIN + href;
