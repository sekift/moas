...
public class SegmentParser {
    private static Logger logger = LoggerFactory.getLogger(SegmentParser.class);
    ...
    public List<TopNews> parser(TopNewsUrl topNewsUrl, Element element){
        ...
        Elements elements = element.getElementsByClass("news-item");
        TopNews topNews = null;
        int j = 1;
        for(int i=0;i<elements.size();i++){
            Element e = elements.get(i);

            String content = e.getElementsByClass("news__item-title").text();
            ...
            String imageurl = e.getElementsByClass("news-img").attr("style");
            ...
            topNews.setLinkurl(Consts.SEGMENT_DOMAIN + linkurl);
