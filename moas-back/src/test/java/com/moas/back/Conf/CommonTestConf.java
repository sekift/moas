//package com.moas.back.Conf;
//
//import com.moas.back.cache.IBaseCache;
//import com.moas.back.cache.impl.BaseCache;
//import com.moas.back.common.LocaleMessage;
//import com.moas.back.util.MyBatisUtil;
//import com.moas.back.util.RedisUtil;
//import com.moas.back.util.SnowflakeIdWorker;
...
//    private static final String PKG_OF_MAPPER = "com.moas.back.dao";
//    private static final String PKG_OF_SERVICE = "com.moas.back.service";
//
...
//        String dirPath = Resources.getResourceURL("com/moas/back/dao").getPath();
...
//        String dirPath = Resources.getResourceURL("com/moas/back/service").getPath();
//            if(dirPath.contains("/test-classes/")){
//            dirPath = dirPath.replace("/test-classes/", "/classes/");
//        }
//        File dir = new File(dirPath);
